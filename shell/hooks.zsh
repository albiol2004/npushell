...
__npushell_precmd() {
    ...
    # Skip signal exits: 130=Ctrl+C, 137=SIGKILL, 141=SIGPIPE, 143=SIGTERM, 126=not executable
    if (( exit_code != 0 && exit_code != 130 && exit_code != 137 && exit_code != 141 && exit_code != 143 && exit_code != 126 )) && [[ -n "$__npushell_last_command" ]]; then
